...
// returns the perimeter of polygon P, which is the sum of Euclidian distances of consecutive line segments (polygon edges)
...
// returns the area of polygon P, which is half the cross products of vectors defined by edge endpoints
